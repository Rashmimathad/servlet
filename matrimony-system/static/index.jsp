...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-danger sticky-sm-top" style="height: 60px;">
...
<div class="position-relative container text-center mt-5 mx-auto p-2">
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-5">
            <a href="matrimonyForm" class="btn btn-danger w-100 mb-3 fw-semibold fs-4">Matrimony Form</a>
        </div>
    </div>
</div>
</body>
