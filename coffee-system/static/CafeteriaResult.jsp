...
<div class='card mb-5 shadow text-center bg-danger bg-gradient p-2 text-dark bg-opacity-25' style='max-width: 640px;'>
    <div class='row g-0'>
        ...
        <div class='col-md-8'>
            <div class='card-body'>
                <h4 class='card-title text-success'><b>Cafeteria Form Submitted Successfully!!!</b></h4><br>
                <h5 class='card-text text-start ps-3'>
                    <strong>Cafeteria Name : </strong> ${cafeteriaName}<br>
                    <strong>Location : </strong> ${location}<br>
                    <strong>Type : </strong> ${type}<br>
                    <strong>Price : </strong> ${price}<br>
                    <strong>Franchise Name : </strong> ${franchiseName}<br>
                    <strong>Owner Name : </strong> ${ownerName}<br>
                    <strong>GST Number : </strong> ${gstNo}<br>
                </h5>
